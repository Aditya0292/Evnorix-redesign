...
export default function CollectionsPage() {
  return (
    <>
      {/* ─────────────────────────────────────────────────────────────
          1. HERO SECTION: Collections Services
         ───────────────────────────────────────────────────────────── */}
      <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-28 px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <SectionReveal delay={0.1}>
                <p className="text-muted text-lg sm:text-xl leading-relaxed max-w-2xl mb-8">
                  Technology and workflow services that help lending institutions manage collections operations, automated borrower follow-ups, field activity, and real-time portfolio recovery visibility.
                </p>
              </SectionReveal>
            ...
            {/* Right: Live Interactive Workflow Queue Card */}
              ...
              <SectionReveal delay={0.2}>
                <div className="relative rounded-2xl bg-gradient-to-b from-[#0A1C16] to-[#06140F] border border-[#193E30] p-6 text-white shadow-2xl overflow-hidden">
                  ...
                  <div className="space-y-3">
                    {[
                      { account: 'Acme Commercial #9421', bucket: '1-30 DPD', action: 'Automated SMS & Payment Link', status: 'Payment Scheduled' },
      ...
      {/* ─────────────────────────────────────────────────────────────
          2. CAPABILITY MODULES (As required in Section 3 & 10 of Brief)
         ───────────────────────────────────────────────────────────── */}
      <section className="py-20 lg:py-28 px-6 lg:px-8 bg-linen">
        <div className="max-w-7xl mx-auto">
          <SectionReveal>
            <div className="max-w-2xl mb-14">
              ...
              <h2 className="font-display font-bold text-3xl sm:text-4xl text-ink leading-tight">
                End-to-End Collections Infrastructure
              </h2>
            </div>
          </SectionReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: 'Configurable Collection Workflows',
                desc: 'Design automated escalation trees, outreach triggers, and payment reminder cadences tailored to delinquency buckets.',
              },
              {
                title: 'Task & Follow-up Automation',
                desc: 'Eliminate manual spreadsheet tracking with centralized agent queues, automated call schedules, and promise-to-pay logging.',
              },
              {
                title: 'Field Activity Tracking',
                desc: 'Coordinate field recovery teams with geo-tagged visit verification, mobile status updates, and live visit receipt generation.',
              },
              {
                title: 'Instant Payment Portals & Links',
                desc: 'Generate secure self-service payment links for borrowers via SMS and email with real-time settlement reconciliation.',
              },
              {
                title: 'Recovery Analytics & Visibility',
                desc: 'Track roll rates, collector performance metrics, cash recovery projections, and vintage curve analytics in real time.',
              },
              {
                title: 'Compliance & Audit trails',
                desc: 'Maintain complete compliance with lending regulations, immutable call logs, and structured communication histories.',
              },
            ].map((cap, idx) => (
